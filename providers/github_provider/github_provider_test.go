...
func TestCreateRepoNoError(t *testing.T) {
	...
	restclient.AddMockup(restclient.Mock{
		...
		Response: &http.Response{
			StatusCode: http.StatusCreated,
			Body:       ioutil.NopCloser(strings.NewReader(`{"id": 123, "name": "golang-tutorial", "full_name":"jakubr7/golang-tutorial"}`)),
		},
	})
	...
	assert.EqualValues(t, "jakubr7/golang-tutorial", response.FullName)
}
