...
import (
	"golang_mvc/git_repo/src/api/config"
	"golang_mvc/git_repo/src/api/domain/github"
	"golang_mvc/git_repo/src/api/domain/repositories"
	githubprovider "golang_mvc/git_repo/src/api/providers/github_provider"
...
func (s *reposService) createRepoConcurrent(input repositories.CreateRepoRequest, output chan repositories.CreateRepositoriesResult) {
	...
	/*
		...
		result, err := githubprovider.CreateRepo(config.GetGithubAccessToken(), request)
	*/
